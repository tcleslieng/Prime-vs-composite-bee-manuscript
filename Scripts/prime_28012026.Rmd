...
trainingphase3confintlow <-(exp(0.2581226)/(1 + exp(0.2581226)))
trainingphase3confinthigh <-(exp(0.6249301)/(1 + exp(0.6249301)))
print(trainingphase3confintlow)
print(trainingphase3confinthigh)
```
