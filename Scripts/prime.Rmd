...
exp2graph <- ggplot() +
  labs(x = "Condition", y = NULL) +  # Set y-axis title to NULL
...
ggsave("figx.pdf", device = pdf, height= 4, width=8, dpi = 300, path = "../Output")
ggsave("figx.png", device = png, height= 4, width=8, dpi = 300, path = "../Output")


figx2 <- congraph + trngraph
figx2 + plot_annotation(tag_levels = "A")
ggsave("figx2.pdf", device = pdf, height= 4, width=8, dpi = 300, path = "../Output")
ggsave("figx2.png", device = png, height= 4, width=8, dpi = 300, path = "../Output")
trngraph2
