...
congraph <- ggplot()+
  ...
  geom_hline(yintercept = 0.5, linetype = "dashed", colour = " black") +
  geom_point(data = controlpoints, aes(x = TEST, y = prop, fill = CONDITION), position = position_jitterdodge(jitter.width=0.2, jitter.height = 0.01, dodge.width = 0.9),       show.legend = FALSE, size =1, colour="black") +
...
trngraph
ggsave("figx.pdf", device = pdf, height= 5, width=6, dpi = 300, path = "Output")
```
