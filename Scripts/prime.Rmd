...
exp1graph <- ggplot()+
  ...
  geom_bar(data = dframe, aes(x = Test, y = proportion, fill = Test), stat = "identity", position = "dodge") + 
   geom_point(data = exp1points, aes(x = TEST, y = prop), position = position_jitter(width=0.1), size =0.5, colour="black") +
...
exp2graph <- ggplot()+
  ...
  geom_bar(data = dframe2, aes(x = Test, y = proportion, fill = Test), stat = "identity", position = "dodge") + 
   geom_point(data = exp2points, aes(x = TEST, y = prop), position = position_jitter(width=0.1), size =0.5, colour="black") +
...
congraph <- ggplot()+
  ...
  geom_hline(yintercept = 0.5, linetype = "dashed", colour = " black") +
  geom_point(data = controlpoints, aes(x = TEST, y = prop, fill = CONDITION), position = position_jitterdodge(jitter.width=0.2, jitter.height = 0.01, dodge.width = 0.9),       show.legend = FALSE, size =0.5, colour="black") +
...
trngraph <- ggplot()+
  ...
  geom_bar(data = dframetrn, aes(x = Test, y = proportion, fill = Test), stat = "identity", position = "dodge") + 
   geom_point(data = trainingpoints, aes(x = CONDITION, y = prop), position = position_jitter(width=0.1), size =1, colour="black") +
...
trngraph2 <- ggplot()+
  ...
  geom_bar(data = dframetrn2, aes(x = Stimuli, y = proportion, fill = Stimuli), stat = "identity", position = "dodge") + 
   geom_point(data = trainingpoints2, aes(x = STIMULI, y = prop), position = position_jitter(width=0.1), size =2, colour="black") +
  ...
  theme(panel.background = element_blank(),
        ...
        axis.title.y = element_text(vjust = 5),
        axis.title.x = element_text(vjust = -3),
        plot.margin = margin(1,1,1,1, "cm")) + theme(axis.title = element_text(size = 20),
    axis.text.x = element_text(size = 20),
    axis.text.y = element_text(size = 15)) + theme(legend.position = "none")
```
...
```{r message=FALSE}
exp1graph <- exp1graph+
    annotate("text", x = 0.7, y = 0.95, label = "A", size = 5, fontface = "bold")
exp2graph <- exp2graph+
    annotate("text", x = 0.7, y = 0.95, label = "B", size = 5, fontface = "bold")
...
congraph <- congraph+
    annotate("text", x = 0.8, y = 1, label = "A", size = 5, fontface = "bold")
trngraph <- trngraph+
    annotate("text", x = 0.7, y = 0.95, label = "B", size = 5, fontface = "bold")
figx2 <- congraph + trngraph
figx2
ggsave("figx2.pdf", device = pdf, height= 4, width=10, dpi = 300, path = "Output")
